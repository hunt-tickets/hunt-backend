-- Create bank_details table for Latin America scalability
...
CREATE TABLE public.bank_details (
    ...
    bank_code TEXT, -- Código del banco específico del país
    branch_code TEXT, -- Código de sucursal/agencia
    swift_code TEXT, -- Para transferencias internacionales
    routing_number TEXT, -- Número de ruta (usado en algunos países)
